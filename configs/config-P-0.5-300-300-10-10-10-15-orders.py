...
'order_rate'               : 0.5, # float, new orders submitted per second. may be 0 or float('inf')
'courier_arrival_min'      : 300, # float, min seconds before courier arrives, in random range
'courier_arrival_max'      : 300, # float, max, ditto above
