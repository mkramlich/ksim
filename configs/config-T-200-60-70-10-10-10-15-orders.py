...
'order_rate'               : 200, # float, new orders submitted per second. may be 0 or float('inf')
'courier_arrival_min'      : 60, # float, min seconds before courier arrives, in random range
'courier_arrival_max'      : 70, # float, max, ditto above
